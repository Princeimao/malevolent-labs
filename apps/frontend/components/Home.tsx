...
export default function Home() {
  const globeConfig = {
    ...
    globeColor: "#10100E",
    showAtmosphere: true,
    atmosphereColor: "#EDE9E0",
    atmosphereAltitude: 0.12,
    emissive: "#10100E",
    emissiveIntensity: 0.05,
    shininess: 0.6,
    polygonColor: "rgba(226,220,208,0.55)",
    ambientLight: "#d8d3c8",
  ...
  const colors = ["#c9c1b1", "#8f8a80", "#7b838e", "#d6cfc0"];
  const sampleArcs = [
    {
      order: 1,
      startLat: -19.885592,
  ...
  return (
    <section className="relative w-full text-black overflow-hidden">
      <div className="relative mx-auto flex min-h-[92svh] w-full max-w-6xl flex-col items-center px-4 pt-24 md:pt-32">
        ...
        {/* Globe */}
        {/* <div className="pointer-events-none absolute  inset-x-0 bottom-0 z-10 h-[68%] w-full md:h-[80%]">
