    ...
    try {
      const agent = await createAgent({
        ...
        focusAreas: values.focusAreas
          ? values.focusAreas.split(",").map((s) => s.trim()).filter(Boolean)
          : [],
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder="e.g. Maya Chen" disabled={creating} {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder="e.g. Staff Engineer" disabled={creating} {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder="https://… (optional)" disabled={creating} {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder="e.g. Analytical, precise, probes trade-offs" disabled={creating} {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder="e.g. Follows up on scaling claims" disabled={creating} {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder="e.g. Challenging & architectural" disabled={creating} {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder="Comma separated — e.g. Scalability, Deadlocks, Trade-offs" disabled={creating} {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder="e.g. default, expressive-01" disabled={creating} {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
              ...
              render={({ field }) => (
                <FormItem className="flex flex-row items-start gap-3 space-y-0">
                  ...
                  <div className="space-y-1">
                    ...
                    <FormDescription className="text-xs">
                      Allow other contributors to use this agent in their interviews.
                    </FormDescription>
                  </div>
                </FormItem>
              )}
      ...
      <main className="max-w-6xl mx-auto px-4 md:px-6 pt-8 space-y-6">
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 border-b border-neutral-800 pb-6">
          <div>
            ...
            <p className="text-neutral-400 text-sm mt-1">
              Create AI interviewers with their own personality, system prompts, and behavior.
            </p>
          </div>
        ...
        <div className="flex items-center gap-2">
          <Button
            ...
            className={onlyMine ? "border-neutral-800" : ""}
          >
        ...
        {loading ? (
          ...
          <Card className="bg-neutral-900/40 border-dashed border-neutral-800">
            <CardContent className="p-10 text-center space-y-3">
              <Bot className="size-10 text-neutral-500 mx-auto" />
              <h3 className="text-sm font-semibold text-white">No agents yet</h3>
              <p className="text-xs text-neutral-500 max-w-sm mx-auto">
                Create your first interviewer agent — then use it to build interview
                rounds in the Interview Studio.
              </p>
                ...
                <CardHeader className="pb-2">
                  <div className="flex items-start gap-3">
                    <div className="size-12 rounded-full bg-gradient-to-tr from-indigo-500 via-purple-500 to-pink-500 overflow-hidden shrink-0">
                      {agent.avatarUrl ? (
                        <img src={agent.avatarUrl} alt={agent.name} className="size-12 object-cover" />
                      ) : (
                ...
                <CardContent className="space-y-3">
                  ...
                  <div className="flex flex-wrap gap-1">
                    {agent.focusAreas.slice(0, 4).map((f) => (
                      <Badge key={f} variant="outline" className="border-neutral-800 text-neutral-400">
                        {f}
                      </Badge>
                    ))}
                  </div>
                  <div className="pt-2 border-t border-neutral-800/70 flex items-center justify-between">
                    <span className="text-[10px] text-neutral-500 font-mono truncate pr-2">
